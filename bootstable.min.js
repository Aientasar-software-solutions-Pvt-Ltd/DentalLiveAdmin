...
var $tab_en_edic = null,
    ...
    colsEdi = null,
    newColHtml =
    '<div class="btn-group"><button id="bEdit" type="button" class="btn btn-sm btn-default" onclick="rowEdit(this);"><i class="material-icons" style="font-size: 1.55rem;color: #07D5E8;">edit </i></button><button id="bElim" type="button" class="btn btn-sm btn-default" onclick="rowElim(this);"><i class="bx bxs-trash" style="font-size: 1.55rem;color:#FA9FBD;"></i></button><button id="bAcep" type="button" class="btn btn-sm btn-default mt-3" style="display:none;" onclick="rowAcep(this);"><i class="bx bx-check-circle" style="font-size: 1.55rem;color: #07D5E8;""></i></button><button id="bCanc" type="button" class="btn btn-sm btn-default mt-3" style="display:none;" onclick="rowCancel(this);"><i class="bx bx-window-close" style="font-size: 1.55rem;color:#FA9FBD;" ></i></button></div>', colEdicHtml = '<td name="buttons">' + newColHtml + "</td>";
$.fn.SetEditable = function (t) {
    var n = { columnsEd: null, $addButton: null, onEdit: function () {}, onDelete: function () {}, onAdd: function () {} };
    (params = $.extend(n, t)),
        this.find("thead tr").append('<th name="buttons" class="p-0"></th>'),
